  ...
  <section class="home-section">
   ...
   <?php require_once 'process.php'; ?> 
    ...
    $result = $mysqli->query("SELECT * FROM class") or die($mysqli->error);
     //pre_r($result);
    ?>
    <h2 class="text-center text-decoration-underline">Choose class</h2>
   ...
   ?>
   <tr>
     <td ><a class="navbar-brand" href="teacher-list.php?class=<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a></td> 
