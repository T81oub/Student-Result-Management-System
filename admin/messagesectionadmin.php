...
<center>
  ...
  <div class="card-body">
    <h4>From: </h4>
    <p class="card-text"><?php echo $row2['username']; ?> <?php echo $row2['surname']; ?> <?php echo $row2['class']; ?><?php echo $row2['id']; ?></p>
    <h5 class="card-title"><?php echo $row['object']; ?></h5>
    <p class="card-text"><?php echo $row['text']; ?></p>
    <a href="messagesectionadmin.php?deleted=<?php echo $row['idm']; ?>"
