...
<div class="container">
  ...
  <div class="container-fluid py-5">
   ...
   <tr>
    ...
    <td>
    <a href="teacher-add.php?editt=<?php echo $row['id']; ?>"
  class="btn btn-info">Edit</a>
    
  <a href="teacher-list.php?deletet=<?php echo $row['id']; ?>"
...
<?php endwhile; ?>
 ...
 <form action="teacher-add.php" method="post">  
    ...
    <input type="submit" value="add teacher" class="btn btn-info btn-lg" name="submit">
 </form>
 </div>
