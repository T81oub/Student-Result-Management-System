...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
  ...
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      <li>
        <a href="messagesectionteacher.php">
      ...
      <li>
        <div class="iocn-link">
          <a href="addresult.php">
            ...
            <span class="link_name">add result</span>
          </a> 
        </div>
      </li>
     
      <li>
        <a href="sendmsgteacher.php">
...
<?php
    ...
    $mysqli = new mysqli('localhost','root','', 'user1') or die(mysqli_error($mysqli));
    $message = $mysqli->query("SELECT * FROM login WHERE  username='$username' AND usertype='teacher' ") or die($mysqli->error);
    
       
       
       
    ?>
   <h2 class="text-center text-decoration-underline">ADD RESULT</h2>
   ...
   ?>
   <tr>
     <td ><a class="navbar-brand" href="classresults.php?classres=<?php echo $row['class']; ?>"><?php echo $row['class']; ?></a></td> 
